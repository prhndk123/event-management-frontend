      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-16 sm:top-full mt-2 sm:w-80 rounded-xl border border-border bg-popover shadow-xl z-50 overflow-hidden"
          >
            {/* Header */}
