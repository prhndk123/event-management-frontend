...
import { getEventBySlug, getEventReviews, submitReview, getCheckInStatus } from "~/services/event.service";
...
export default function EventSlugPage() {
    ...
    const reviewMutation = useMutation({
        mutationFn: (data: { rating: number; comment: string }) =>
            submitReview(Number(event!.id), data),
        onSuccess: () => {
